...
static uint32_t infix_precedences[TOKEN_TYPE_COUNT] = {
	...
	[TOKEN_TYPE_LEFT_ANGLE_BRACKET] = 0,
	[TOKEN_TYPE_LEFT_BRACKET] = 0,
	[TOKEN_TYPE_LEFT_PARENTHESIS] = 0,

	[TOKEN_TYPE_AS] = 0,

	[TOKEN_TYPE_MODULUS] = 0,
	[TOKEN_TYPE_DIVIDE] = 0,
	[TOKEN_TYPE_TIMES] = 0,
	...
	[TOKEN_TYPE_LEFT_SHIFT] = 0,

	[TOKEN_TYPE_RIGHT_SHIFT] = 0,

	[TOKEN_TYPE_BITWISE_AND] = 0,

	[TOKEN_TYPE_BITWISE_XOR] = 0,

	[TOKEN_TYPE_BITWISE_OR] = 0,

	[TOKEN_TYPE_IS] = 0,
	[TOKEN_TYPE_LESS_EQUAL] = 0,
	[TOKEN_TYPE_LESS] = 0,
	[TOKEN_TYPE_GREATER_EQUAL] = 0,
	[TOKEN_TYPE_GREATER] = 0,
	[TOKEN_TYPE_NOT_EQUAL] = 0,
	[TOKEN_TYPE_EQUAL] = 0,
	
	[TOKEN_TYPE_BOOLEAN_NOT] = 0,
	
	[TOKEN_TYPE_BOOLEAN_AND] = 0,
	
	[TOKEN_TYPE_BOOLEAN_XOR] = 0,
	
	[TOKEN_TYPE_BOOLEAN_OR] = 0,
	
	[TOKEN_TYPE_COMMA] = 0,
	
	[TOKEN_TYPE_MODULUS_ASSIGN] = 0,
	[TOKEN_TYPE_RIGHT_SHIFT_ASSIGN] = 0,
	[TOKEN_TYPE_LEFT_SHIFT_ASSIGN] = 0,
	[TOKEN_TYPE_BITWISE_NOT_ASSIGN] = 0,
	[TOKEN_TYPE_BITWISE_XOR_ASSIGN] = 0,
	[TOKEN_TYPE_BITWISE_OR_ASSIGN] = 0,
	[TOKEN_TYPE_BITWISE_AND_ASSIGN] = 0,
	[TOKEN_TYPE_DIVIDE_ASSIGN] = 0,
	[TOKEN_TYPE_TIMES_ASSIGN] = 0,
	[TOKEN_TYPE_MINUS_ASSIGN] = 0,
	[TOKEN_TYPE_PLUS_ASSIGN] = 0,
	[TOKEN_TYPE_ASSIGN] = 0,
};
